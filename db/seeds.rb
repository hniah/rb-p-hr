...
admins_data = [
  ...
  { name: 'HR', english_name: 'HR', email: 'hr@futureworkz.com', personal_email: 'hr@example.com', address: 'Viet Nam', phone_number: '034543534', basic_salary: '223', started_on: '2014/06/16', probation_end_on: '2014/08/16', designation: 'HR' }
]
