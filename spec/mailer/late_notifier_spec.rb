...
describe LateNotifier do
  describe '.more_late' do
    ...
    let!(:EMAIL_NOTIFIER) { create :setting, key: 'EMAIL_NOTIFIER', value: 'martin@futureworkz.com' }
    ...
    it 'System to prompt admin if staff has more than 10 lates this year' do
      ...
      expect(ActionMailer::Base.deliveries.first.to).to include 'martin@futureworkz.com'
    end
  end
end
