...
describe Admin::StaffsController do
  ...
  describe 'PATCH #update' do
    context 'success' do
      ...
      def do_request
        patch :update, id: user.id, staff: attributes_for(:staff, email: 'martin1234@futureworkz.com', password: '123123123', password_confirmation: '123123123', leader_id: leader.id)
      end
